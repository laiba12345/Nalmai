...
The current automated suite contains **113 tests** and is rerun after each implementation task. Framework deprecation warnings under Python 3.14 are tracked separately from Nalmai failures. JavaScript syntax is also checked with Node.
